...
/settings — напоминания и время ежедневной проверки
/app — открыть визуальный дневник (Mini App)

📖 Кнопка «Дневник» слева от поля ввода открывает историю и графики прогресса.`;
